...
namespace Pcx
{
    ...
    public sealed class PointCloudData : ScriptableObject
    {
        ...
        //public void AddData(List<Vector3> positions, List<Color32> colors)
        //{
        //    if(_pointData == null)
        //    {
        ...
        //    else
        //    {
        //        int startPos = _pointData.Length;
        //        Array.Resize(ref _pointData, _pointData.Length + positions.Count);
        //        for (var i = startPos; i < _pointData.Length; i++)
        //        {
        //            _pointData[i] = new Point
        //            {

        //                position = positions[i - startPos],
        //                color = EncodeColor(colors[i - startPos])
        //            };
        //        }
        //    }
        //}
