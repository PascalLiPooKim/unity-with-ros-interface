/**
 * Script to collect data from LiDAR, filtered the pointcloud and publish the pointclouds
 * depeonding on he side of audio sources on the Husky.
 */
...
class LaserToPointcloud{
    ...
    // Search point required for KdTree around which neighbours are searched
    ...
    // Publishers to publish distance of closest objects
    ...
    // Publishers to publish filtered pointclouds
    ...
    // Function to filter pointcloud along only one axis
    ...
    // Function to filter pointcloud along two axes
    void passThroughFilter(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud, 
