...
class LaserToPointcloud{
    ...
    LaserToPointcloud(ros::NodeHandle *nh){
        ...
        rightAudioPub = nh->advertise<geometry_msgs::Vector3>("/audio/minRightPos", 1);
        leftAudioPub = nh->advertise<geometry_msgs::Vector3>("/audio/minLeftPos", 1);
        frontAudioPub = nh->advertise<geometry_msgs::Vector3>("/audio/minFrontPos", 1);
    ...
    void FindClosestPoints(pcl::PointCloud<pcl::PointXYZ>::Ptr cloudOutput){
        ...
        pcl::KdTreeFLANN<pcl::PointXYZ> frontKdtree;
        pcl::PointCloud<pcl::PointXYZ>::Ptr frontFilteredCloud(new pcl::PointCloud<pcl::PointXYZ>);
        passThroughFilter(cloudOutput, frontFilteredCloud, "x", 0.5f, 2.0f, "y", -0.7f, 0.7f); // 0.35 --> 0.5
        ...
        geometry_msgs::Vector3 rightMsgPos;
        geometry_msgs::Vector3 leftMsgPos;
        geometry_msgs::Vector3 frontMsgPos;
        ...
        if(rightFilteredCloud->size() > 0)
        {
            ...
            {   
                ...
                rightMsgPos.x = (*rightFilteredCloud)[rightPointIdxKNNSearch[0]].x;
                rightMsgPos.y = (*rightFilteredCloud)[rightPointIdxKNNSearch[0]].y;
                rightMsgPos.z = (*rightFilteredCloud)[rightPointIdxKNNSearch[0]].z;
            }
            else
            {
                rightMsgPos.x = 0.0f;
        ...
        rightAudioPub.publish(rightMsgPos);
        ...
        if(leftFilteredCloud->size() > 0)
        {
            ...
            {   
                ...
                leftMsgPos.x = (*leftFilteredCloud)[leftPointIdxKNNSearch[0]].x;
                leftMsgPos.y = (*leftFilteredCloud)[leftPointIdxKNNSearch[0]].y;
                leftMsgPos.z = (*leftFilteredCloud)[leftPointIdxKNNSearch[0]].z;
            }
            else
            {
        ...
        leftAudioPub.publish(leftMsgPos);
        ...
        if(frontFilteredCloud->size() > 0)
        {
            ...
            {   
                ...
                frontMsgPos.x = (*frontFilteredCloud)[frontPointIdxKNNSearch[0]].x;
                frontMsgPos.y = (*frontFilteredCloud)[frontPointIdxKNNSearch[0]].y;
                frontMsgPos.z = (*frontFilteredCloud)[frontPointIdxKNNSearch[0]].z;
            }
            else
            {
                frontMsgPos.x = 0.0f;
        ...
        frontAudioPub.publish(frontMsgPos);
