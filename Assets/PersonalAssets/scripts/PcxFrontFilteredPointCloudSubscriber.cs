...
namespace RosSharp.RosBridgeClient
{
    ...
    public class PcxFrontFilteredPointCloudSubscriber : UnitySubscriber<MessageTypes.Sensor.PointCloud2>
    {
        ...
        // Callback to receive message from specified topic before using the values
