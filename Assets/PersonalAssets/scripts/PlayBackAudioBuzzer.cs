...
namespace RosSharp.RosBridgeClient
{
    ...
    public class PlayBackAudioBuzzer : UnitySubscriber<MessageTypes.Std.Float32>
    {
        ...
        private void PlayBuzzer()
        {
                ...
                if (Mathf.Pow(closestDistance.data, 1f / 2f) > 0.0f && Mathf.Pow(closestDistance.data, 1f / 2f) < 0.6f)
                {
